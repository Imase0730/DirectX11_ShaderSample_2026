...
namespace Imase
{
    ...
    public:
        ...
        // チャンクデータ書き出し関数
        static void WriteChunk(std::ofstream& ofs, uint32_t type, const std::vector<uint8_t>& data)
        {
            ChunkHeader header{};
            header.type = type;
        ...
        // チャンクデータを読み込む関数
        static bool ReadChunk(std::ifstream& ifs, ChunkHeader& header, std::vector<uint8_t>& buffer)
        {
