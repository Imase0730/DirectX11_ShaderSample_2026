...
// コンストラクタ
Imase::NormalMapShader::NormalMapShader(ID3D11Device* device)
{
    const wchar_t* vs_name = L"Resources/Shaders/NormalMapVS.cso";
    const wchar_t* ps_name = L"Resources/Shaders/NormalMapPS.cso";
...
// バインド関数
void Imase::NormalMapShader::Bind(ID3D11DeviceContext* context)
{
    // 頂点シェーダーの設定
